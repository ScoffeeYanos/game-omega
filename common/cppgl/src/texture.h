  ...
  case GL_FLOAT:
    return channels == 4 ? GL_RGBA32F : channels == 3 ? GL_RGB32F
                                    : channels == 2   ? GL_RG32F
                                                      : GL_R32F;
  case GL_HALF_FLOAT:
    return channels == 4 ? GL_RGBA16F : channels == 3 ? GL_RGB16F
                                    : channels == 2   ? GL_RG16F
                                                      : GL_R16F;
  case GL_BYTE:
  case GL_UNSIGNED_BYTE:
    return channels == 4 ? GL_RGBA8 : channels == 3 ? GL_RGB8
                                  : channels == 2   ? GL_RG8
                                                    : GL_R8;
  case GL_SHORT:
    return channels == 4 ? GL_RGBA16 : channels == 3 ? GL_RGB16
                                   : channels == 2   ? GL_RG16
                                                     : GL_R16;
  case GL_INT:
    return channels == 4 ? GL_RGBA32I : channels == 3 ? GL_RGB32I
                                    : channels == 2   ? GL_RG32I
                                                      : GL_R32I;
  default:
...
public:
  ...
  Texture2DImpl(const std::string &name, const fs::path &path, bool mipmap = true, bool flipped = true);
